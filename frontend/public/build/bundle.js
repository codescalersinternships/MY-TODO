...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$7, 79, 6, 2522);
    			attr_dev(div1, "class", "count");
    			add_location(div1, file$7, 82, 6, 2626);
    			attr_dev(div2, "class", "status svelte-ajrd20");
    			add_location(div2, file$7, 78, 4, 2495);
    			attr_dev(div3, "id", "todos3");
    			add_location(div3, file$7, 84, 4, 2699);
    			attr_dev(div4, "class", "list svelte-ajrd20");
    			add_location(div4, file$7, 77, 2, 2472);
    		},
    		m: function mount(target, anchor) {
    ...
    // (75:0) {#if error || $TodoListStore.length === 0}
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$7, 75, 2, 2412);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(75:0) {#if error || $TodoListStore.length === 0}",
    		ctx
    	});
    ...
    // (86:6) {#each filteredTodoList.slice(3 * currentPage, 3 * (currentPage + 1)) as todo, index (todo.ID)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$7, 86, 8, 2827);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(86:6) {#each filteredTodoList.slice(3 * currentPage, 3 * (currentPage + 1)) as todo, index (todo.ID)}",
    		ctx
    	});
